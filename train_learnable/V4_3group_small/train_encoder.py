...
class AngleTrainerWrapper:
    def __init__(self, config_path=r"train_learnable\v4_3group_small\config\train_config.json"):
...
def main():
    ...
    try:
        # 可以指定不同的配置文件
        config_path = r"train_learnable\v4_3group_small\config\train_config.json"
