...
class AngleTrainerWrapper:
    def __init__(self, config_path=r"Ablation_eperience\train\ZRCP_Hard_Chunking\v1\config\train_config.json"):
...
def main():
    ...
    try:
        # 可以指定不同的配置文件
        config_path = r"Ablation_eperience\train\ZRCP_Hard_Chunking\v1\config\train_config.json"
