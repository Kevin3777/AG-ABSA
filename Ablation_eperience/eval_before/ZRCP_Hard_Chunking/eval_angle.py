...
MODEL_PATH_ANGLE = r'checkpoints_ablation/ZRCP_Hard_Chunking_v1'  # 修改为你的模型路径

# 结果保存目录
RESULTS_DIR = r"Ablation_eperience\eval\ZRCP_Hard_Chunking\result\evaluation_results_cv_standard"
BATCH_SIZE = 128
N_FOLDS = 5                # 交叉验证折数
RANDOM_STATE = 42
