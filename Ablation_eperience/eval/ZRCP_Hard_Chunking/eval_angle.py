...
TEST_CSV = r'asap-master\data\test.csv'

# 模型路径配置 - 指向你训练好的Checkpoint
MODEL_PATH = r'checkpoints_ablation/ZRCP_Hard_Chunking_v1'  # 修改为你的模型路径

# 结果保存目录
OUTPUT_DIR = r"Ablation_eperience\eval\ZRCP_Hard_Chunking\result\evaluation_results_new_standard"
BATCH_SIZE = 128
MAX_LEN = 512
RANDOM_STATE = 42
