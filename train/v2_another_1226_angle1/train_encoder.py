...
class AngleTrainerWrapper:
    def __init__(self, config_path=r"train\v2_another_1226_angle1\config\train_config.json"):
...
def main():
    ...
    try:
        # 可以指定不同的配置文件
        config_path = r"train\v2_another_1226_angle1\config\train_config.json"
